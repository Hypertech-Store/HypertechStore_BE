...
Route::prefix('san-pham')->group(function () {
    ...
    Route::get('/bien-the/{id}', [SanPhamController::class, 'getProductVariants']);
    ...
    Route::get('/san-pham-lien-quan/{sanPhamId}', [SanPhamController::class, 'getSanPhamTheoDanhMucTuSanPhamId']);
